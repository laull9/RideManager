...
internal static unsafe partial class RknnNative
{
    ...
    /// 创建 RKNN native 上下文。
    /// </summary>
    [DllImport("ridemanager_rknn", EntryPoint = "rm_rknn_create", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern int Create(string modelPath, out IntPtr context);

    /// <summary>
    /// 销毁 RKNN native 上下文。
    /// </summary>
    [DllImport("ridemanager_rknn", EntryPoint = "rm_rknn_destroy", CallingConvention = CallingConvention.Cdecl)]
    public static extern void Destroy(IntPtr context);

    /// <summary>
    /// 运行一次 RKNN 推理。
    /// </summary>
    [DllImport("ridemanager_rknn", EntryPoint = "rm_rknn_run", CallingConvention = CallingConvention.Cdecl)]
    public static extern int Run(IntPtr context, RknnInputTensor* inputs, int inputCount);

    /// <summary>
    /// 获取模型输入数量。
    /// </summary>
    [DllImport("ridemanager_rknn", EntryPoint = "rm_rknn_get_input_count", CallingConvention = CallingConvention.Cdecl)]
    public static extern int GetInputCount(IntPtr context);

    /// <summary>
    /// 获取输入张量 metadata。
    /// </summary>
    [DllImport("ridemanager_rknn", EntryPoint = "rm_rknn_get_input_metadata", CallingConvention = CallingConvention.Cdecl)]
    public static extern int GetInputMetadata(IntPtr context, int inputIndex, RknnTensorMetadata* metadata);

    /// <summary>
    /// 获取上一次推理的输出数量。
    /// </summary>
    [DllImport("ridemanager_rknn", EntryPoint = "rm_rknn_get_output_count", CallingConvention = CallingConvention.Cdecl)]
    public static extern int GetOutputCount(IntPtr context);

    /// <summary>
    /// 获取输出张量 metadata。
    /// </summary>
    [DllImport("ridemanager_rknn", EntryPoint = "rm_rknn_get_output_metadata", CallingConvention = CallingConvention.Cdecl)]
    public static extern int GetOutputMetadata(IntPtr context, int outputIndex, RknnTensorMetadata* metadata);

    /// <summary>
    /// 获取输出张量 float32 数据指针。
    /// </summary>
    [DllImport("ridemanager_rknn", EntryPoint = "rm_rknn_get_output_data", CallingConvention = CallingConvention.Cdecl)]
    ...
    /// </summary>
    [DllImport("ridemanager_rknn", EntryPoint = "rm_rknn_get_last_error", CallingConvention = CallingConvention.Cdecl)]
